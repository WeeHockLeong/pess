...
if (isset($_POST["btnUpdate"])){
  ...
  $sql = "UPDATE patrolcar SET PatrolCarStatusId = '".$_POST['patrolcar_status']."' WHERE PatrolCarId = '".$_POST['PatrolCarId']."'";
  if ($conn->query($sql)===FALSE) {
	echo "Error: " . $sql . "<br>" . $conn->error;
  }
  
  /* if patrol car status is Arrived (4) then capture the time of arrival */
  if ($_POST["patrolcar_status"] == '4'){
  ...
  else if ($_POST["patrolcar_status"] == '3'){	
...
<form name="form2" method="post"
  ...
  <table>
    ...
    <tr>
      <td>Status :</td>
      <td><select name="patrolcar_status" id="patrolcar_status">
